...
import CreateProjects from "../agent-templates/CreateProject";
...
const CardTemplates = ({
  ...
  const { onCreateLoading, onCreate } = useCreateProject({
    // departmentId,
    projectInfo,
    workspaceId,
    getConfig,
    ...
    <div className="w-full">
      <div className="flex px-4 border-b text-gray-500 justify-between items-center">
        ...
        <div className="flex items-center flex-col">
          <p className="text-xl text-gray-500">Select Your Sphere</p>
      ...
      {showTemplateModal && (
        <AgentTemplateModal
          ...
          onCreateLoading={onCreateLoading}
          onCreate={onCreate}
        />
      )}
